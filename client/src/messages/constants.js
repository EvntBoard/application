const messages = {
  ...
  AppTriggerMenuReload: 'app.trigger.menu.reload',
  AppTriggerMenuEditFile: 'app.trigger.menu.file_edit',
  ...
  AppTriggerButtonEditFile: 'app.trigger.event.button.editfile',
